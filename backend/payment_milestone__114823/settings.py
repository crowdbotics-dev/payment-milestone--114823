"""
Django settings for payment_milestone__114823 project.
...
ROOT_URLCONF = 'payment_milestone__114823.urls'
...
WSGI_APPLICATION = 'payment_milestone__114823.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "payment_milestone__114823 API",
    "DESCRIPTION": "API documentation for payment_milestone__114823 App",
    "VERSION": "v1",
}
